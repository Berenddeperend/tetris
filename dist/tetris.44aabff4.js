...
function () {
  ...
  Block.prototype.init = function (renderTo) {
    ...
    this.d3Self = d3RenderTarget.select("svg") // .insert("g", this.stage.gridOverBlocks ? ":first-child" : null)
    .insert("g", this.stage.gridOverBlocks ? '.gridlines' : null).attr("class", "block " + this.color);
    this.draw();
  };
...
},{"./block":"src/block.ts","d3-selection":"node_modules/d3-selection/src/index.js","./utils":"src/utils.ts","./tetris":"src/tetris.ts","./gestureControls":"src/gestureControls.ts","./keyboardControls":"src/keyboardControls.ts","./touchControls":"src/touchControls.ts"}],"src/splash.ts":[function(require,module,exports) {
"use strict";
