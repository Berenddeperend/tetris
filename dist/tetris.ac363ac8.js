...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","preact":"node_modules/preact/dist/preact.module.js","../utils":"src/utils.tsx"}],"src/stage.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Stage.prototype.initUI = function () {
    ...
    this.d3Stage.append("svg").attr('class', 'stage-svg').attr("style", "width: " + this.gridWidth * this.blockSize / 10 + "rem; height: " + this.gridHeight * this.blockSize / 10 + "rem"); // .append("rect")
    // .attr("class", "berend")
...
},{"./block":"src/block.ts","d3-selection":"node_modules/d3-selection/src/index.js","./utils":"src/utils.tsx","./highScores":"src/highScores.tsx","./states/pause":"src/states/pause.tsx","./dom":"src/dom.ts"}],"src/states/splash.tsx":[function(require,module,exports) {
"use strict";
