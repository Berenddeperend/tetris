...
function () {
  ...
  Block.prototype.rotate = function () {
    ...
    var shapeMayRotate = function shapeMayRotate(shape) {
    ...
    var newShape = buildRotatedShape(this.shape);
    ...
    var offset = amountOfAtomsThatWillRotateOutOfBounds(newShape);
...
function () {
  function Gestures(stage) {
    ...
    this.sensitivity = 10; //higher is less sensitive;

    this.swipeCounter = 0;
    this.dir = "";
    var body = document.querySelector("body");
    var gestures = new hammerjs_1.default(body, {});
    gestures.on("panleft panright panup tap ", function (e) {
      switch (e.type) {
        case "panleft":
          return _this.throttledFn("panleft", function () {
            return stage.controls.left();
          });

        case "panright":
          return _this.throttledFn("panright", function () {
            return stage.controls.right();
          });

        case "panup":
          return _this.throttledFn("panup", function () {
            return stage.controls.instaFall();
          });

        case "pandown":
          return _this.throttledFn("pandown", function () {
...
},{"./block":"src/block.ts","d3-selection":"node_modules/d3-selection/src/index.js","./utils":"src/utils.ts","./tetris":"src/tetris.ts","./gestureControls":"src/gestureControls.ts","./keyboardControls":"src/keyboardControls.ts"}],"src/splash.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Splash() {
    ...
    splash.append("div").attr("class", "begin").selectAll("span").data("press space to start".split("")).enter().append("span").attr("class", "letter").attr("style", function (d, i) {
