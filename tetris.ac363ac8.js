...
},{"preact":"node_modules/preact/dist/preact.module.js"}],"node_modules/d3-selection/src/namespaces.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Block.prototype.init = function (renderTo) {
    ...
    if (renderTo === "stage") {
      this.d3Shadow = d3RenderTarget.select("svg").insert("g", this.stage.gridOverBlocks ? ".gridlines" : null).attr("class", "block " + this.color + " shadow");
    }
    ...
    this.shape.map(function (y, yI) {
      y.map(function (x, xI) {
        if (x && y) {
          ...
          if (_this.hasShadow) {
            _this.d3Shadow.append("rect").attr("width", _this.stage.blockSize).attr("height", _this.stage.blockSize).attr("x", xI * _this.stage.blockSize).attr("y", yI * _this.stage.blockSize).attr("class", "atom shadow");
          }
        }
      });
    });
    ...
    get: function get() {
      ...
      return this.shape.map(function (row, rowIndex) {
        return row.map(function (atom, columnIndex) {
          if (!atom) return true;
          return _this.stage.internalGrid[_this.y + rowIndex] && _this.stage.internalGrid[_this.y + rowIndex][_this.x + columnIndex] === 0;
        });
  ...
  Block.prototype.clearRow = function (rowIndex) {
    ...
    var self = this;
    var targetAtoms = this.d3Self.selectAll("rect[y=\"" + targetAtomsYValue + "\"]");
    var animationDurationPerAtom = this.stage.clearAnimationDuration / (this.stage.gridWidth / 2);

    targetAtoms._groups[0].forEach(function (atom, atomXIndex) {
      var internalOffset = _this.shape[targetShapeRowIndex].findIndex(function (a) {
        return !!a;
      }); //for when the first atom in a row no longer exists.


      var absX = atomXIndex + self.x + internalOffset - 5;
      if (absX < 0) absX++;
      setTimeout(function () {
        d3_selection_1.select(atom).attr('class', "atom hibbem");
  ...
  Block.prototype.getShadowYPos = function () {
    var _this = this;

    var yOffsetFromShape = 0;

    var blockWillCollideYAfterNSteps = function blockWillCollideYAfterNSteps(yOffsetFromShape) {
      return _this.shape.map(function (row, rowIndex) {
        return row.map(function (atom, columnIndex) {
          if (!atom) return false; //Empty atom in this slot

          if (_this.y + rowIndex + yOffsetFromShape >= _this.stage.gridHeight) {
            return true; //Block reached bottom of stage
          }

          return (//returns the value of the target spot in the internal grid for the atom
            _this.stage.internalGrid[_this.y + rowIndex + yOffsetFromShape] && _this.stage.internalGrid[_this.y + rowIndex + yOffsetFromShape][_this.x + columnIndex]
          );
        });
  ...
  Block.prototype.removeShadow = function () {
  ...
  Block.prototype.updateGroupPosition = function () {
    ...
    if (this.hasShadow) {
      var targetYPos = this.getShadowYPos();
      this.d3Shadow.attr("transform", "translate(" + this.x * this.stage.blockSize * scale + ", " + (this.y + targetYPos - 1) * this.stage.blockSize * scale //todo: improve
      + ") scale(" + scale + ")");
    }
  };
...
},{"d3-selection":"node_modules/d3-selection/src/index.js","./possibleBlocks":"src/possibleBlocks.ts","./utils":"src/utils.tsx"}],"src/states/pause.tsx":[function(require,module,exports) {
"use strict";
...
function () {
  function Pause() {
    ...
    preact_1.render(jsx_runtime_1.jsx("div", __assign({
      class: "pause-container"
    }, {
      children: jsx_runtime_1.jsx("div", __assign({
        class: "pause"
      }, {
        children: utils_1.explodeText('pause')
      }), void 0)
    }), void 0), stage);
    stage.classList.add("is-paused");
  }

  Pause.removePause = function () {
    var stage = document.querySelector(".stage");
...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","preact":"node_modules/preact/dist/preact.module.js","../utils":"src/utils.tsx"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
},{}],"node_modules/virtual-clock/dist/virtual-clock.mjs":[function(require,module,exports) {
...
class VirtualClock {
  ...
  constructor() {
    ...
    this._nullTimeoutID = setTimeout(() => {}, 0); // Make private properties non-enumerable
  ...
  _recalculateTimeListener(listener) {
    ...
    if (listenerData) {
      ...
      const [timeoutID, lastCalled, once] = listenerData; // Clear any open timeouts
      ...
      if (this._running && this._rate !== 0 && time >= this._minimum && time <= this._maximum) {
        // Get current time
        const currentTime = this.time; // Did we already run at this time?
        ...
        if (currentTime === lastCalled) {
          ...
          let until; // Initial calculation depends on which way time is moving
          ...
          if (until >= 0 || this._loop && this._minimum > -Infinity && this._maximum < Infinity) {
            ...
            if (until > 0x7fffffff) {
              ...
              newTimeoutID = setTimeout(() => this._recalculateTimeListener(listener), untilRecalculate);
            } else {
              newTimeoutID = setTimeout(() => {
                ...
                callback.call(this); // Recalculate the time listener
  ...
  removeAt(time, callback) {
    ...
    let hasRemoved = false; // Loop over all listeners
  ...
  get time() {
    let currentTime = this._previousTime; // If running, the time is has changed since the previous time so we recalculate it
  ...
  set minimum(minimum) {
    ...
    if (minimum !== this._minimum) {
      ...
      const previousTime = this.time; // Change the minimum
  ...
  set maximum(maximum) {
    ...
    if (maximum !== this._maximum) {
      ...
      const previousTime = this.time; // Change the maximum
...
},{"process":"node_modules/process/browser.js"}],"node_modules/htm/dist/htm.module.js":[function(require,module,exports) {
"use strict";
...
exports.html = html;
},{"htm":"node_modules/htm/dist/htm.module.js","preact":"node_modules/preact/dist/preact.module.js"}],"src/stage.ts":[function(require,module,exports) {
"use strict";
...
var pause_1 = __importDefault(require("./states/pause"));

var virtual_clock_1 = __importDefault(require("virtual-clock"));
...
function () {
  function Stage(_a, game) {
    ...
    this.clock = new virtual_clock_1.default();
    this.clock.minimum = 0;
    this.clock.maximum = 1000;
    this.clock.loop = true;
    this.clock.alwaysAt(1000, function () {
      // this.clock.time = 0;
      _this.tick();
    });
    this.clock.start();
      ...
      return {
        ...
        pause: function pause() {
          if (_this.isPaused) {
            ...
            pause_1.default.removePause();
          } else {
            _this.isPaused = true;

            _this.clock.stop();

            _this.pause = new pause_1.default();
          }
        }
      };
    },
  ...
  Stage.prototype.finishBlock = function (block) {
    ...
    this.completedRows.map(function (rowIndex) {
      ...
      var level = Math.floor(_this.clearedLines / 3);
      _this.clock.rate = 1 + level / 2;
  ...
  Stage.prototype.initUI = function () {
    ...
    highScore.append("div").attr("class", "value").text((_a = this.game.serverHighScore) === null || _a === void 0 ? void 0 : _a.score);
    this.drawGridLines();
    this.updateScoreUI();
  };
...
},{"./block":"src/block.ts","d3-selection":"node_modules/d3-selection/src/index.js","./utils":"src/utils.tsx","./states/pause":"src/states/pause.tsx","virtual-clock":"node_modules/virtual-clock/dist/virtual-clock.mjs","./dom":"src/dom.ts"}],"src/states/splash.tsx":[function(require,module,exports) {
"use strict";
  ...
  function Splash(game) {
    ...
    var html = jsx_runtime_1.jsxs("div", __assign({
      ...
      children: [jsx_runtime_1.jsx("div", __assign({
        ...
        children: [jsx_runtime_1.jsxs("a", __assign({
          href: links.github,
          target: "_blank"
        }, {
          children: [jsx_runtime_1.jsx("pre", {
            children: "["
          }, void 0), "G", jsx_runtime_1.jsx("pre", {
            children: "]"
          }, void 0), "ithub"]
        }), void 0), jsx_runtime_1.jsxs("a", __assign({
          href: links.highscores,
          target: "_blank"
        }, {
          children: [jsx_runtime_1.jsx("pre", {
            children: "["
          }, void 0), "H", jsx_runtime_1.jsx("pre", {
            children: "]"
          }, void 0), "ighscores"]
  ...
  Object.defineProperty(Splash.prototype, "controls", {
    get: function get() {
      ...
      return {
        ...
        openHighscores: function openHighscores() {
...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","preact":"node_modules/preact/dist/preact.module.js","../utils":"src/utils.tsx"}],"src/animations.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  HighScores.prototype.draw = function () {
    ...
    var html = jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, {
      children: [jsx_runtime_1.jsx("div", __assign({
        class: "highscore-title-container"
      }, {
        children: jsx_runtime_1.jsx("h3", __assign({
          className: "highscore-title"
        }, {
          children: "Highscores"
        }), void 0)
      }), void 0), jsx_runtime_1.jsx("div", __assign({
    ...
    setTimeout(function () {
      if (_this.game.gameState !== 'highScore') return;
  ...
  HighScores.prototype.setScore = function (highScore) {
    ...
    return new Promise(function (resolve) {
      fetch("https://berendswennenhuis.nl/tetris/api" + "/score", {
        method: "POST",
        headers: {
  ...
  HighScores.prototype.fetchHighScoresFromBackend = function () {
    ...
    return new Promise(function (resolve) {
      fetch("https://berendswennenhuis.nl/tetris/api" + "/scores").then(function (res) {
        return res.json();
...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","./dom":"src/dom.ts","preact":"node_modules/preact/dist/preact.module.js","./animations":"src/animations.ts"}],"src/ThreeLetterInput.tsx":[function(require,module,exports) {
"use strict";
...
var d3_selection_1 = require("d3-selection"); // const buttons = ['left', 'right', 'up', 'down', 'rotate']
...
function () {
  function TouchControls(game) {
    ...
    this.game = game;
    var uiContainer = d3_selection_1.select('body').append('div').attr('class', 'joypad');
    var directionsGroup = uiContainer.append('div').attr('class', 'directions');
    var actionsGroup = uiContainer.append('div').attr('class', 'actions');
    directions.map(function (direction) {
      directionsGroup.append('button').attr('class', "joypad-btn " + direction).text(direction).attr('direction', direction);
    });
    actions.map(function (action) {
      actionsGroup.append('button').attr('class', "joypad-btn " + action).text(action).attr('direction', action);
    });
    this.init();
  }
...
},{"d3-selection":"node_modules/d3-selection/src/index.js"}],"node_modules/hammerjs/hammer.js":[function(require,module,exports) {
var define;
...
function () {
  ...
  Tetris.prototype.fetchHighScore = function () {
    ...
    fetch("https://berendswennenhuis.nl/tetris/api" + "/scores") // fetch(`https://berendswennenhuis.nl/scores`)
    .then(function (res) {
      return res.json();
    }).then(function (scores) {
