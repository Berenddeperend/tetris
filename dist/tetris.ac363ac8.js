...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","preact":"node_modules/preact/dist/preact.module.js","./animations":"src/animations.ts","./inputName":"src/inputName.tsx"}],"src/controls/controls.ts":[function(require,module,exports) {
"use strict";
...
function setControls(state, stateControls) {
  ...
  exports.controls[state] = stateControls;
  console.log(exports.controls); // setTimeout(() => {
  //   controls.splash.continue();
  // }, 1000);
}

exports.default = setControls;
},{}],"src/Defaults.ts":[function(require,module,exports) {
"use strict";
...
function GridLines(settings) {
  // const argumentedSettings = { ...defaultGameSettings, settings };
  // const { width, blockSize, height } = { augumentedSettings };
  var _a = __assign(__assign({}, Defaults_1.defaultGameSettings), settings),
      width = _a.width,
      blockSize = _a.blockSize,
      height = _a.height,
      gridGutterSize = _a.gridGutterSize;

  return jsx_runtime_1.jsx("svg", __assign({
    class: "yebuddy"
  }, {
    children: jsx_runtime_1.jsxs("g", __assign({
      class: "gridlines",
...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","./Defaults":"src/Defaults.ts"}],"src/stage.tsx":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function Stage(props) {
    ...
    _this.clearedLines = 0;
    _this.game = game;
    _this.gridWidth = width;
    _this.gridHeight = height; // this.blockSize = this.game.isDesktop ? blockSize : 18;

    _this.blockSize = blockSize;
    _this.gridGutterSize = gridGutterSize;
    _this.gridOverBlocks = gridOverBlocks;
    _this.queueScaleFactor = queueScaleFactor; // this.initUI();
    ...
    _this.activeBlock = new block_1.default(_this.blockIndex, _this, "stage");

    _this.queue.push(new block_1.default(++_this.blockIndex, _this, "queue"));

    document.documentElement.style.setProperty("--stage-height", _this.gridHeight * _this.blockSize / 10 + "rem");
    document.documentElement.style.setProperty("--stage-width", _this.gridWidth * _this.blockSize / 10 + "rem");
  ...
  Stage.prototype.render = function () {
    return jsx_runtime_1.jsxs(jsx_runtime_1.Fragment, {
      children: [jsx_runtime_1.jsx("div", {
        ...
        children: jsx_runtime_1.jsx(GridLines_1.default, {}, void 0)
      }), void 0)]
    }, void 0);
  };
...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","./block":"src/block.tsx","d3-selection":"node_modules/d3-selection/src/index.js","./utils":"src/utils.tsx","./highScores":"src/highScores.tsx","./controls/controls":"src/controls/controls.ts","preact":"node_modules/preact/dist/preact.module.js","./GridLines":"src/GridLines.tsx"}],"src/states/splash.tsx":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function Splash() {
    var _this = _super.call(this) || this; // initControls({
    //   continue: ()=> {
...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","preact":"node_modules/preact/dist/preact.module.js","../utils":"src/utils.tsx","../animations":"src/animations.ts","./../controls/controls":"src/controls/controls.ts"}],"src/states/gameOver.tsx":[function(require,module,exports) {
"use strict";
...
},{"hammerjs":"node_modules/hammerjs/hammer.js"}],"node_modules/preact/devtools/dist/devtools.module.js":[function(require,module,exports) {
"use strict";
  ...
  Tetris.prototype.render = function () {
    ...
    switch (this.state.gameState) {
      ...
      case "playing":
        ...
        return jsx_runtime_1.jsx(stage_1.default, {}, void 0);
        return;
