...
},{"preact/jsx-runtime":"node_modules/preact/jsx-runtime/dist/jsxRuntime.module.js","preact":"node_modules/preact/dist/preact.module.js","../utils":"src/utils.tsx"}],"node_modules/htm/dist/htm.module.js":[function(require,module,exports) {
"use strict";
...
},{"./block":"src/block.ts","d3-selection":"node_modules/d3-selection/src/index.js","./utils":"src/utils.tsx","./states/pause":"src/states/pause.tsx","./dom":"src/dom.ts"}],"src/states/splash.tsx":[function(require,module,exports) {
"use strict";
  ...
  function Splash(game) {
    ...
    this.html = jsx_runtime_1.jsxs("div", __assign({
      ...
      children: [jsx_runtime_1.jsx("div", __assign({
        ...
        children: "By Berend"
      }), void 0), jsx_runtime_1.jsxs("ul", __assign({
        class: "menu"
      }, {
        children: [jsx_runtime_1.jsxs("li", __assign({
          class: "menu-item active"
        }, {
          children: [this.modSelectedMenuItemIndex === 0 ? utils_1.explodeText("Press space to start") : "Press space to start", this.modSelectedMenuItemIndex]
        }), void 0), jsx_runtime_1.jsx("li", __assign({
          class: "menu-item"
        }, {
          children: "highscores"
        }), void 0)]
    ...
    preact_1.render(this.html, document.querySelector('.tetris'));
  }

  Splash.prototype.setSelectedMenuItem = function () {
    document.querySelector('.menu-item.active').classList.remove('active');
    document.querySelector(".menu-item:nth-of-type(" + (this.modSelectedMenuItemIndex + 1) + ")").classList.add('active');
    preact_1.render(this.html, document.querySelector('.tetris'));
  };

  Object.defineProperty(Splash.prototype, "modSelectedMenuItemIndex", {
    get: function get() {
  ...
  Object.defineProperty(Splash.prototype, "controls", {
    get: function get() {
      ...
      return {
        ...
        up: function up() {
          _this.selectedMenuItemIndex--;

          _this.setSelectedMenuItem();
        },
        down: function down() {
          _this.selectedMenuItemIndex++;
